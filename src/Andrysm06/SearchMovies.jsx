...
function MovieDetail() {
  ...
  const fetchMovieDetail = async () => {
    try {
      const [movieResponse, trailerResponse, genresResponse] =
        await Promise.all([
          axios.get(
      ...
      const movieGenres = movieResponse.data.genres.map((genre) =>
  ...
  useEffect(() => {
    ...
    setIsLoggedIn(!!token); // Shorter way to set isLoggedIn
  }, []);
            ...
            {!isLoggedIn ? (
              <div className="flex flex-col items-center justify-center h-screen bg-gray-900 text-white">
                <p className="text-lg mb-4">
                  Anda harus login terlebih dahulu untuk melihat detail film.
                </p>
                <motion.a
